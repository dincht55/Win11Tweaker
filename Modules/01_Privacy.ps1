<#
.SYNOPSIS
    Windows 11 設定精靈 - 模組 01:隱私與遙測 (Privacy & Telemetry)

.DESCRIPTION
    停止系統層級的資料回傳與追蹤 (Telemetry、廣告 ID、活動記錄、剪貼簿雲同步、
    量身打造、意見反應、位置、手寫輸入、線上語音、WER、CEIP、線上提示)。
    提問模式:選項式 (統一模型)。

    模組本體僅負責載入知識庫並呼叫引擎,不內嵌資料;所有設定項與選項設計
    由 Data\kb_01_Privacy.psd1 提供。
...
$ModuleTitle = Get-Text "cat_01"   # 隱私與遙測
...
# ============================================================
$kbFile = Join-Path $Global:DataPath "kb_01_Privacy.psd1"
